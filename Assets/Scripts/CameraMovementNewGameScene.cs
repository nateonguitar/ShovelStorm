...
public class CameraMovementNewGameScene : MonoBehaviour {
    GameObject[] cells = new GameObject[100];
    Vector3 initialPosition;
    Vector3[] cellCameraMovements = new Vector3[100];
    float[] cellDurations = new float[100];
    ...
    public void Start()
    {
        ...
        cells[0] = GameObject.FindWithTag("Cell0");
        cells[1] = GameObject.FindWithTag("Cell1");
        cellDurations[0] = 5f;
        cellDurations[1] = 4f;
        cellCameraMovements[0] = new Vector3(-0.75f, 0.25f, -9.5f);
        cellCameraMovements[1] = new Vector3(-2f, 4f, -9.5f);
        initialPosition = transform.position;

        for(int i=1; i<cellDurations.Length; i++)
        {
